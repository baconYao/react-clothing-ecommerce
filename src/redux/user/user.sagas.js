...
export function* onCheckUserSession() {
  yield takeLatest(userAcyionTypes.CHECK_USER_SESSION, isUserAuthenticated);
}

export function* onSignOutStart() {
  yield takeLatest(userAcyionTypes.SIGN_OUT_START, signOut);
}

export function* onSignUpStart() {
  yield takeLatest(userAcyionTypes.SIGN_UP_START, signUp);
}

export function* onSignUpSuccess() {
  yield takeLatest(userAcyionTypes.SIGN_UP_SUCCESS, signInAfterSignUp);
}
